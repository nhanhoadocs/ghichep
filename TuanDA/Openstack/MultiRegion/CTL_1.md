...
## Cài 
### Cấu hình IP
vlan mgnt : ens160: 172.16.3.220
vlan data-vm : ens224: 10.10.23.220
vlan provider: ens192: 10.10.22.220
Neu cai dat tren ao hoa ESXi  phai emable mode ao hoa.

hostnamectl set-hostname controller
echo "nameserver 8.8.8.8" > /etc/resolv.conf
echo "Setup IP  ens160"
nmcli c modify ens160 ipv4.addresses 172.16.3.220/20
...
nmcli c modify ens192 ipv4.addresses 10.10.22.220/24
nmcli c modify ens192 ipv4.method manual
nmcli con mod ens192 connection.autoconnect yes
 
echo "Setup IP  ens224"
nmcli c modify ens224 ipv4.addresses 10.10.23.220/24
...
echo "172.16.3.220 controller" >> /etc/hosts
echo "172.16.3.221 compute01" >> /etc/hosts
...
sed -i "s/-l 127.0.0.1,::1/-l 172.16.3.220/g" /etc/sysconfig/memcached
...
sed -i -e 's/VirtualHost \*/VirtualHost 172.16.3.220/g' /etc/httpd/conf.d/wsgi-keystone.conf
sed -i -e 's/Listen 5000/Listen 172.16.3.220:5000/g' /etc/httpd/conf.d/wsgi-keystone.conf
sed -i -e 's/Listen 35357/Listen 172.16.3.220:35357/g' /etc/httpd/conf.d/wsgi-keystone.conf
sed -i -e 's/^Listen.*/Listen 172.16.3.220:80/g' /etc/httpd/conf/httpd.conf
...
[credential]
[database]
connection = mysql+pymysql://keystone:Welcome123@172.16.3.220/keystone
[domain_config]
[endpoint_filter]
[endpoint_policy]
[eventlet_server]
...
export OS_AUTH_URL=http://172.16.3.220:35357/v3
...
openstack --os-auth-url http://172.16.3.220:35357/v3 \
...
openstack endpoint create --region RegionOne image public http://172.16.3.220:9292
openstack endpoint create --region RegionOne image admin http://172.16.3.220:9292
openstack endpoint create --region RegionOne image internal http://172.16.3.220:9292
...
[DEFAULT]
bind_host = 172.16.3.220
registry_host = 172.16.3.220
[cors]
[database]
connection = mysql+pymysql://glance:Welcome123@172.16.3.220/glance
[glance_store]
stores = file,http
default_store = file
...
auth_url = http://172.16.3.220:5000
...
auth_uri = http://172.16.3.220:5000
auth_url = http://172.16.3.220:5000
memcached_servers = 172.16.3.220
auth_type = password
project_domain_name = Default
user_domain_name = Default
project_name = service
...
openstack endpoint create --region RegionOne compute public http://172.16.3.220:8774/v2.1
openstack endpoint create --region RegionOne compute admin http://172.16.3.220:8774/v2.1
openstack endpoint create --region RegionOne compute internal http://172.16.3.220:8774/v2.1
...
openstack endpoint create --region RegionOne placement public http://172.16.3.220:8778
openstack endpoint create --region RegionOne placement admin http://172.16.3.220:8778
openstack endpoint create --region RegionOne placement internal http://172.16.3.220:8778
...
use_neutron = True
osapi_compute_listen=172.16.3.220
metadata_host=172.16.3.220
metadata_listen=172.16.3.220
metadata_listen_port=8775
firewall_driver = nova.virt.firewall.NoopFirewallDriver
transport_url = rabbit://openstack:Welcome123@172.16.3.220:5672
[api]
auth_strategy = keystone
[api_database]
connection = mysql+pymysql://nova:Welcome123@172.16.3.220/nova_api
[barbican]
[cache]
backend = oslo_cache.memcache_pool
enabled = true
memcache_servers = 172.16.3.220:11211
[cells]
[cinder]
[compute]
[conductor]
...
[crypto]
[database]
connection = mysql+pymysql://nova:Welcome123@172.16.3.220/nova
[devices]
[ephemeral_storage_encryption]
[filter_scheduler]
[glance]
api_servers = http://172.16.3.220:9292
[guestfs]
[healthcheck]
[hyperv]
[ironic]
...
[vmware]
[vnc]
novncproxy_host=172.16.3.220
enabled = true
vncserver_listen = 172.16.3.220
vncserver_proxyclient_address = 172.16.3.220
novncproxy_base_url = http://172.16.3.220:6080/vnc_auto.html
[workarounds]
[wsgi]
[xenserver]
[xvp]
...
sed -i -e 's/VirtualHost \*/VirtualHost 172.16.3.220/g' /etc/httpd/conf.d/00-nova-placement-api.conf
sed -i -e 's/Listen 8778/Listen 172.16.3.220:8778/g' /etc/httpd/conf.d/00-nova-placement-api.conf
...
openstack endpoint create --region RegionOne network public http://172.16.3.220:9696
openstack endpoint create --region RegionOne network internal http://172.16.3.220:9696
openstack endpoint create --region RegionOne network admin http://172.16.3.220:9696
...
[cors]
[database]
connection = mysql+pymysql://neutron:Welcome123@172.16.3.220/neutron
[keystone_authtoken]
auth_uri = http://172.16.3.220:5000
...
<html>
<head>
<META HTTP-EQUIV="Refresh" Content="0.5; URL=http://172.16.3.220/dashboard">
</head>
<body>
...
CACHES = {
    'default': {
         ...
         'LOCATION': ['172.16.3.220:11211',],
    }
}
OPENSTACK_HOST = "172.16.3.220"
OPENSTACK_KEYSTONE_URL = "http://172.16.3.220:5000/v3"
...
openstack endpoint create --region RegionOne volumev2 public http://172.16.3.220:8776/v2/%\(project_id\)s
openstack endpoint create --region RegionOne volumev2 internal http://172.16.3.220:8776/v2/%\(project_id\)s
openstack endpoint create --region RegionOne volumev2 admin http://172.16.3.220:8776/v2/%\(project_id\)s
openstack endpoint create --region RegionOne volumev3 public http://172.16.3.220:8776/v3/%\(project_id\)s
openstack endpoint create --region RegionOne volumev3 internal http://172.16.3.220:8776/v3/%\(project_id\)s
openstack endpoint create --region RegionOne volumev3 admin http://172.16.3.220:8776/v3/%\(project_id\)s
...
transport_url = rabbit://openstack:Welcome123@172.16.3.220:5672
auth_strategy = keystone
osapi_volume_listen = 172.16.3.220
...
[cors]
[database]
connection = mysql+pymysql://cinder:Welcome123@172.16.3.220/cinder
[fc-zone-manager]
[healthcheck]
[key_manager]
[keystone_authtoken]
